              ...
              <div className="space-y-8 text-gray-700">
                ...
                <section>
                  ...
                  <p className="leading-relaxed mb-3">
                    By providing your mobile number, you consent to receive SMS messages related to:
                  </p>
                  <ul className="space-y-2 mb-3">
                    ...
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-primary-500 rounded-full mr-3 mt-2 flex-shrink-0"></span>
                      <div>Insurance quote follow-ups</div>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-primary-500 rounded-full mr-3 mt-2 flex-shrink-0"></span>
                      <div>Account or service updates</div>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-primary-500 rounded-full mr-3 mt-2 flex-shrink-0"></span>
                      <div>Information or support you requested</div>
                    </li>
                  </ul>
                  <p className="leading-relaxed mb-3">
                  ...
                  <div className="bg-primary-50 border border-primary-200 rounded-lg p-4 mb-3">
                    <p className="font-semibold text-navy-900 mb-2">STOP</p>
                    <p className="text-gray-700">Reply STOP to unsubscribe. You will receive one final confirmation message.</p>
                  </div>
                  <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
                    <p className="font-semibold text-navy-900 mb-2">HELP</p>
                    <p className="text-gray-700">Reply HELP for support or email support@mrecai.com.</p>
                  </div>
                </section>
                ...
                <section>
                  ...
                  <p className="leading-relaxed mb-3">You represent that:</p>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-primary-500 rounded-full mr-3 mt-2 flex-shrink-0"></span>
                      <div>You are the owner or authorized user of the mobile number you provide.</div>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-primary-500 rounded-full mr-3 mt-2 flex-shrink-0"></span>
                      <div>You voluntarily opt in to receive messages.</div>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-primary-500 rounded-full mr-3 mt-2 flex-shrink-0"></span>
                      <div>You understand that consent is not required to purchase services.</div>
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    5) Scope of Services & Third-Party Control
                  </h2>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    7) Ownership; License; IP Reservation
                  </h2>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    11) No Warranties; Use at Your Own Risk
                  </h2>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    15) Third-Party Services; No Endorsement or Guarantee
                  </h2>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    18) Marketing; Automatic Opt-In; Opt-Out
                  </h2>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    21) Severability; Cumulative Remedies; Survival
                  </h2>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    23) Binding Arbitration; Fee-Shifting; Class-Action & Jury Waiver
                  </h2>
