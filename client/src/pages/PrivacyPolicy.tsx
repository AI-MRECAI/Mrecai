              ...
              <div className="space-y-8 text-gray-700">
                ...
                <section>
                  ...
                  <p className="leading-relaxed mb-3">
                    By submitting any form on our website or providing your phone number through any channel, you expressly consent to receive SMS messages from MRE Consulting & Insurance for:
                  </p>
                  <ul className="space-y-2 mb-3">
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-primary-500 rounded-full mr-3 mt-2 flex-shrink-0"></span>
                      <div>Appointment updates</div>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-primary-500 rounded-full mr-3 mt-2 flex-shrink-0"></span>
                      <div>Quote follow-ups</div>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-primary-500 rounded-full mr-3 mt-2 flex-shrink-0"></span>
                    ...
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-primary-500 rounded-full mr-3 mt-2 flex-shrink-0"></span>
                      <div>Information you requested</div>
                    </li>
                  </ul>
                  <p className="leading-relaxed mb-3">
                    <strong>Message & data rates may apply. Message frequency varies.</strong>
                  </p>
                  <div className="bg-primary-50 border border-primary-200 rounded-lg p-4 mb-3">
                    <p className="font-semibold text-navy-900 mb-2">STOP Instructions</p>
                    <p className="text-gray-700">Reply STOP at any time to unsubscribe and no further messages will be sent.</p>
                  </div>
                  <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
                    <p className="font-semibold text-navy-900 mb-2">HELP Instructions</p>
                    <p className="text-gray-700">Reply HELP for assistance or email support@mrecai.com.</p>
                  </div>
                </section>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    6) Automatic Enrollment in Communications (Opt-Out Anytime)
                  </h2>
                  <p className="leading-relaxed">By providing contact information or using the Services, you automatically consent to receive email, phone, and digital advertising from us and our service providers. Opt-out at any time by clicking "Unsubscribe," or emailing privacy@mrecai.com with "Opt-Out."</p>
                </section>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    9) Data Security & Your Acceptance of Risk
                  </h2>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    11) Your Responsibilities & Verification
                  </h2>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    13) Third-Party Links & Independent Contractors
                  </h2>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    14) Global Transfers & Export Compliance
                  </h2>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    15) Your Rights (U.S. State & International)
                  </h2>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-navy-900 mb-4 flex items-center">
                    <span className="w-1 h-6 bg-primary-500 rounded-full mr-3"></span>
                    16) "No Liability for Third-Party Breaches"
                  </h2>
